...
PROJECT_DIR="$WORKSPACE_ROOT/repos/landing-pages/sites.lucidity.design"
HOST="127.0.0.1"
START_PORT="${SITES_LUCIDITY_DESIGN_PORT:-4182}"
MAX_PORT="${SITES_LUCIDITY_DESIGN_MAX_PORT:-4299}"
