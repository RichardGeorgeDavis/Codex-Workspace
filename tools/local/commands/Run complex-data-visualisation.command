...
PROJECT_DIR="$WORKSPACE_ROOT/repos/current-builds/complex-data-visualisation"
HOST="127.0.0.1"
START_PORT="${COMPLEX_DATA_VIS_PORT:-5173}"
MAX_PORT="${COMPLEX_DATA_VIS_MAX_PORT:-5299}"
