...
1. **Handover:** Batches 1–4 complete; v1.2.2 baseline. Optional follow-ons: MCP profiles, capability drill-down, repo-intake polish. Completion review open themes: diagnostics, favourites, dependency feedback, mapped-host preview polish, runtime troubleshooting docs.
