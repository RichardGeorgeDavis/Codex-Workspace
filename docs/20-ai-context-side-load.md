...
For optional local-first extraction and task-scoped handovers built on this
side-load contract, see [24-local-model-context-handover.md](24-local-model-context-handover.md).
...
3. record the repo closeout in tracked docs
