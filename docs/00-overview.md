...
- future long-term memory or retrieval infrastructure only after review
...
8. update public-facing docs when workspace-wide features such as capability lifecycle changes land
