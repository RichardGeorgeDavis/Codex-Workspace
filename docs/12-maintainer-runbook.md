...
No workspace memory runtime is installed by default. Record closeout in tracked
repo docs, `docs/HANDOVER.md`, and `docs/CHANGELOG.md` as appropriate.

Memory-related references such as Neo4j-backed hooks remain reference-only until
a separate review promotes a replacement.
...
- this is especially important for workspace-wide features such as capability lifecycle changes, tracked skill distribution, and Hub-visible operator flows
