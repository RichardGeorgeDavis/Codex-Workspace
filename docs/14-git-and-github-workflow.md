...
- In Codex Workspace, closeout belongs in tracked docs: repo-specific handovers should update repo-local docs, and workspace-level handovers should update `docs/HANDOVER.md` plus `docs/CHANGELOG.md`.
